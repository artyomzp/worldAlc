...
<body>
    <div id="app">
            <div class="categoryheader text-center">
            <h1 class="text-center">WORLD ALCOHOL</h1> 
            <p class="text-center"> Best of the Best</p>
            
            {!! Form::open(array('action'=>'SearchController@search', 'class'=>'form-inline')) !!}
